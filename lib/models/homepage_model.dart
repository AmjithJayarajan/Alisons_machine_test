...
class HomePageModel {
  int success;
  String message;
  List<HomeBanner> banner1;
  List<dynamic> banner2;
  List<HomeBanner> banner3;
  List<HomeBanner> banner4;
  ...
  factory HomePageModel.fromJson(Map<String, dynamic> json) => HomePageModel(
    ...
    banner1: List<HomeBanner>.from(json["banner1"].map((x) => HomeBanner.fromJson(x))),
    banner2: List<dynamic>.from(json["banner2"].map((x) => x)),
    banner3: List<HomeBanner>.from(json["banner3"].map((x) => HomeBanner.fromJson(x))),
    banner4: List<HomeBanner>.from(json["banner4"].map((x) => HomeBanner.fromJson(x))),
...
class HomeBanner {
  ...
  factory HomeBanner.fromRawJson(String str) => HomeBanner.fromJson(json.decode(str));
